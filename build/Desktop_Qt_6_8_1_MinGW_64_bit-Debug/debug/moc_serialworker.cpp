...
#include "C:/Users/ADMIN/Downloads/CANOPEN-QT/serialworker.h"
...
static constexpr auto qt_meta_stringdata_ZN12SerialWorkerE = QtMocHelpers::stringData(
    "SerialWorker",
    "dataReceived",
    "",
    "data",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SerialWorkerE[] = {
...
Q_CONSTINIT const QMetaObject SerialWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SerialWorkerE.offsetsAndSizes,
    qt_meta_data_ZN12SerialWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SerialWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SerialWorker::*)(const QByteArray & );
            if (_q_method_type _q_method = &SerialWorker::dataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SerialWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SerialWorkerE.stringdata0))
